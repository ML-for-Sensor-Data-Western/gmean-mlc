...
class MultiLabelDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        self.num_train_saples = self.train_dataset.num_samples
...
class BinaryRelevanceDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        # split dataset
        if stage == "fit":
            self.train_dataset = BinaryRelevanceDataset(
                self.ann_root,
                self.data_root,
                split="Train",
                transform=self.train_transform,
            ...
            self.val_dataset = BinaryRelevanceDataset(
                self.ann_root,
                self.data_root,
                split="Val",
                transform=self.eval_transform,
        ...
        if stage == "test":
            self.test_dataset = BinaryRelevanceDataset(
                self.ann_root,
                self.data_root,
                split="Test",
                transform=self.eval_transform,

...
class MultiLabelDatasetCoco(Dataset):
    ...
    def _load_annotations(self):
        gtPath = os.path.join(self.annRoot, "instances_{}2017_balanced.json".format(self.split.lower()))
...
if __name__ == "__main__":
    ...
    train = MultiLabelDatasetCoco(annRoot="/mnt/datassd0/coco-2017/annotations/", imgRoot="/mnt/datassd0/coco-2017/images/all_images", split="Train", transform=transform)
